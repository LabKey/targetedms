...
public class TargetedMSExperimentIrtTest extends TargetedMSIrtTest
{
    ...
    public void testSteps()
    {
        ...
        assertEquals("Incorrect total iRT peptide count.", PEPTIDE_COUNT * 2, getRowCount());
        assertEquals("Incorrect number of rows for iRT peptide " + UPDATE_PEPTIDE, 2, getRowsForPeptide(UPDATE_PEPTIDE).size());
    }
}
