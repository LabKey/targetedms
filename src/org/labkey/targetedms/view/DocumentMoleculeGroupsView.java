...
public class DocumentMoleculeGroupsView extends QueryView
{
    ...
    public DocumentMoleculeGroupsView(ViewContext ctx, TargetedMSSchema schema, long runId, boolean forExport)
    {
        super(schema, schema.getSettings(ctx, DATAREGION_NAME, TargetedMSSchema.TABLE_PEPTIDE_GROUP), null);
        _schema = schema;
        _runId = runId;
        setTitle(TITLE);
    }
