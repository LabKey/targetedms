...
public class DocumentProteinView extends QueryView
{
    private final TargetedMSSchema _schema;
    private final long _runId;

    public DocumentProteinView(ViewContext ctx, TargetedMSSchema schema, long runId)
    {
        super(schema, schema.getSettings(ctx, TargetedMSSchema.TABLE_PROTEIN, TargetedMSSchema.TABLE_PROTEIN), null);
        _schema = schema;
        _runId = runId;
        setTitle("Proteins");
    }
