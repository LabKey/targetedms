...
public class DocumentProteinsView extends QueryView
{
    public static final String DATAREGION_NAME = "document_proteins_view";
    public static final String TITLE = "Proteins";

    private final TargetedMSSchema _schema;
    private final long _runId;

    public DocumentProteinsView(ViewContext ctx, TargetedMSSchema schema, long runId, boolean forExport)
    {
        super(schema, schema.getSettings(ctx, DATAREGION_NAME, TargetedMSSchema.TABLE_PROTEIN), null);
        _schema = schema;
        _runId = runId;
        setTitle(TITLE);
    }
