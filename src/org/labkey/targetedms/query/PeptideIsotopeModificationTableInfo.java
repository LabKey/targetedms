...
{
    public PeptideIsotopeModificationTableInfo(TargetedMSSchema schema, ContainerFilter cf)
    {
        super(TargetedMSManager.getTableInfoPeptideIsotopeModification(), schema, cf);
