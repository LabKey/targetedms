...
-- script from develop
CREATE PROCEDURE targetedms.ensureSchedulerTables AS
BEGIN
    IF NOT EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'msInstrument')
BEGIN
execute ('
...
EXEC targetedms.ensureSchedulerTables
GO
DROP PROCEDURE targetedms.ensureSchedulerTables
