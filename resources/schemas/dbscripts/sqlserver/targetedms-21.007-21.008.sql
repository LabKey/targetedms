...
INSERT INTO targetedms.QCMetricConfiguration (Container, Name, Series1Label, Series1SchemaName, Series1QueryName, PrecursorScoped, EnabledQueryName, EnabledSchemaName) VALUES
    (@rootIdentity, 'iRT Slope', 'Slope', 'targetedms', 'QCRunMetric_iRTSlope', 0, 'QCRunMetricEnabled_iRTSlope', 'targetedms');

INSERT INTO targetedms.QCMetricConfiguration (Container, Name, Series1Label, Series1SchemaName, Series1QueryName, PrecursorScoped, EnabledQueryName, EnabledSchemaName) VALUES
    (@rootIdentity, 'iRT Intercept', 'Intercept', 'targetedms', 'QCRunMetric_iRTIntercept', 0, 'QCRunMetricEnabled_iRTIntercept', 'targetedms');

INSERT INTO targetedms.QCMetricConfiguration (Container, Name, Series1Label, Series1SchemaName, Series1QueryName, PrecursorScoped, EnabledQueryName, EnabledSchemaName) VALUES
    (@rootIdentity, 'iRT Correlation', 'Correlation', 'targetedms', 'QCRunMetric_iRTCorrelation', 0, 'QCRunMetricEnabled_iRTCorrelation', 'targetedms');
