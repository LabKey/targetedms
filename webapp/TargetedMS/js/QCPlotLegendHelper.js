...
if (!LABKEY.targetedms.QCPlotLegendHelper) {
    LABKEY.targetedms.QCPlotLegendHelper = {
        ...
        setupLegendPrefixes: function (items, minLength) {
            ...
            for (var item in items) {
                if (items.hasOwnProperty(item) && items[item].fragment !== undefined && items[item].fragment !== '' &&
        ...
        getUniquePrefix: function (identifier, isPeptide) {
            ...
            matchingPrefixAndSuffix.forEach(function (prefSuf) {
