        ...
        if (this.precursors && this.precursors.length) {
            ...
            summaryDataTable.forEach(function(row, index) {
                ...
                tableHTML += commonRows +
                        ...
                        '<td style="text-align: right; ' + (row.totalCV > 20 ? 'color: darkred; font-weight: bold;' : '') + '">' + LABKEY.Utils.encodeHtml((row.totalCV).toFixed(1)) + '%</td>' +
                ...
                if (row.heavyCharge) {
                    ratioTableHTML += commonRows +
                            ...
                            '<td style="text-align: right; ' + (row.ratioTotalCV > 20 ? 'color: darkred; font-weight: bold;' : '') + '">' + LABKEY.Utils.encodeHtml((row.ratioTotalCV).toFixed(1)) + '%</td>' +
